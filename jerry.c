...
int main(int argc, char *argv[])
{
    ...
    if (argc == 1)
    {
        ...
        printf("3. stop_block username filename: It will stop blocking user to open the file.\n");
...
return 0;
        ...
        else if (strcmp(argv[1], "help") == 0)
        {
            ...
            printf("stop_block username filename: It will stop blocking the user to open the file.(the user)\n");
            printf("stop_protect username: It will stop preventing a killing processes made by the user.(The user is the most recent user which you put)\n");
        ...
        else if (strcmp(argv[1], "block") == 0)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    printf("Now %s can't open %s file with uid %d\n", user_pw->pw_name, argv[3], user_pw->pw_uid);
        ...
        else if (strcmp(argv[1], "protect") == 0)
        {
            ...
            else
            {
                ...
                //Pass data to /proc/mousehole
                printf("Now It will help to protect %s's processes to kill with uid %d\n", argv[2], user_pw->pw_uid);
        ...
        else if (strcmp(argv[1], "stop_block") == 0)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    printf("Now %s can open %s file with uid %d\n", user_pw->pw_name, argv[3], user_pw->pw_uid);
                    fprintf(fp, "3 %d %s", user_pw->pw_uid, argv[3]);
                    fclose(fp);
                    return -1;
                }
            }
        ...
        else if (strcmp(argv[1], "stop_protect") == 0)
        {
            ...
            else
            {
                ...
                //Pass data to /proc/mousehole
                printf("Now processed which made by %s %d can be killed.\n", argv[2], user_pw->pw_uid);
                fprintf(fp, "4 %d", user_pw->pw_uid);
                fclose(fp);
                return -1;
            }
        }
